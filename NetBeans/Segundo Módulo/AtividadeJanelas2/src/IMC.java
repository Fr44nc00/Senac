...
public class IMC extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Interp = new javax.swing.JTextPane();
                    ...
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addComponent(TxAltura, javax.swing.GroupLayout.PREFERRED_SIZE, 328, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel2Layout.createSequentialGroup()
        ...
        Interp.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        jScrollPane2.setViewportView(Interp);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String mensagem, alturaStr = TxAltura.getText(), pesoStr = TxPeso.getText();
        ...
        if (!alturaStr.isEmpty() && !pesoStr.isEmpty()) {
            try {
                ...
                Interp.setText(mensagem);
            } catch (NumberFormatException e) {
                Interp.setText("Valores inválidos, tente novamente.");
            }
        } else {
            Interp.setText("Preencha todos os campos.");
        }
    ...
    private javax.swing.JTextPane Interp;
