...
public final class TelaInicio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Boas vindas ao sistema de agendamento"));
    ...
    public void atualizarLista() {
        ...
        if (!listaPessoa.isEmpty()) {
            ...
            for (int i = 0; i < listaPessoa.size(); i++) {
                ...
                if (consultaAtual.getConsultaRealizada()) {
                    consRealizada = "Sim";
                } else {
                    consRealizada = "Não";
                }
    ...
    private void BtFinalizarConsultaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtFinalizarConsultaActionPerformed
        ...
        if (linhaSelecionada != -1) {
            Consulta consultaSelecionada = listaConsulta.get(linhaSelecionada);
