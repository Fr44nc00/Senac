...
public class Listagem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        List<portalaluno.model.Aluno> listaCompleta = portalaluno.model.ListaAluno.Listar();

        // Para cada item que houver na lista de alunos, iremos adicionar uma nova linha na nossa tabela
        for(int i = 0; i < listaCompleta.size(); i++) {
            // Extraímos os dados
            portalaluno.model.Aluno alunoAtual = listaCompleta.get(i);
