...
public class FuncionarioDAO {
    ...
    //Primeiramente, criam-se as variáveis, pois elas são necessárias para conexão
    //e manipulação de dados, e o ResultSet para as consultas:
    PreparedStatement st;
    ResultSet rs;
    
    public Connection conn;//criando um objeto do tipo connection chamado conn
    public String url = "jdbc:mysql://localhost:3306/exemplo_senac_2"; //Nome da base de dados
    public String user = "root"; //nome do usuário do MySQL
    public String password = "simone04";
