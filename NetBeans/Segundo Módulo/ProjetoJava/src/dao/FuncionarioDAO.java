...
public class FuncionarioDAO {
    ...
    public void inserir(Funcionario funcionario){
        ...
        //Primeiro, é necessário invocar método para realizar a conversão da data
        //para o padrão brasileiro. Utilize a classe SimpleDateFormat,
        //usando o padrão de data “yyyy/MM/dd”. Tenha cuidado ao informar o mês,
        //ele deve ser “MM”, pois, caso você use “mm” (com letras minúsculas),
        //a classe entenderá que você está fornecendo os minutos.
        //O bloco de código será este:
        ...
        try {
            ...
            //Dentro do try, a única alteração que será feita é usando o objeto
            //instanciado da classe SimpleDataFormat. Você realizará a conversão da data:
