...
public class Relatorios extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton4.setText("Lucro?");

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setText("Funcionarios:\nMostrar funcionario, nome e aniversário\n\nVenda: mostrar vendas do dia, semana \nMês\n\nLucro: puxar o valor total de vendas da\ndo dia, semana e mês\n");
