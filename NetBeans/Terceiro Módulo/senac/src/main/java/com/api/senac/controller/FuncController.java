...
public class FuncController {
    ...
    public String viewHomePage(Model model) {
        model.addAttribute("listarFuncionarios", funcionarioService
    ...
    public String salvarFuncionario(@Valid @ModelAttribute("funcionario")
            FuncionarioEntity func, BindingResult result) {
        if (result.hasErrors()) {
            return "inserir";
        }
        if (func.getId() == null) {
    ...
    public String atualizarFuncionarioForm(@PathVariable(value = "id")
