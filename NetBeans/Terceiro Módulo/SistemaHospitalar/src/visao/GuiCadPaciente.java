...
public class GuiCadPaciente extends javax.swing.JInternalFrame {
    ...
    private void cadastrar() {
        try {
            ...
            sdf.setLenient(false); // Configuração para garantir que a data seja
            // estritamente validada
            ...
            if (jtNome.getText().isEmpty() ||
                ...
                jtEmail1.getText().isEmpty()) {
                JOptionPane.showMessageDialog(this, "Por favor, preencha todos os "
                        + "campos obrigatórios.");
                return;
            }

            // Verificando se a data de nascimento está no formato correto
            try {
                sdf.parse(jtDataNasc.getText());
            } catch (Exception e) {
            ...
            if (!jtEmail1.getText().matches(emailPattern)) {
                JOptionPane.showMessageDialog(this, "Email inválido. Use o formato "
                        + "exemplo@dominio.com.");
                return;
            }
            ...
            if (!jtCpf.getText().matches(cpfPattern)) {
                JOptionPane.showMessageDialog(this, "CPF inválido. Use o formato "
                        + "123.456.789-00.");
                return;
            }

            // Validando formato do RG
            String rgPattern = "\\d{7}";
            if (!jtRG.getText().matches(rgPattern)) {
                JOptionPane.showMessageDialog(this, "RG inválido. Use o formato "
                        + "1234567.");
                return;
            }

            // Criando um objeto Paciente para atribuir valores
            Paciente pac = new Paciente();

            // Atribuindo valores aos atributos do Paciente com base nos campos
            // preenchidos pelo usuário na tela
            ...
            if (!(jcConvenio.getSelectedIndex() == 0)) {
                ...
                // Criando objeto ConvenioDAO para buscar o convênio no banco de
                // dados
                ConvenioDAO convDAO = new ConvenioDAO();

                // Buscando o convênio no banco de dados com base no nome
            ...
            // Criando objeto PacienteDAO para cadastrar o paciente no banco de
            // dados
