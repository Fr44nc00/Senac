package com.senac.projectmvc.controller; 
import com.senac.projectmvc.controller.model.Pessoa;
...
public class MiscController { 
    ...
    public String converteTemperatura(Model model, @RequestParam(defaultValue="0")int
            valor){ 
    ...
    @GetMapping("/pessoa") 
    public String mostraPessoa(Model model, String nome,
            @RequestParam(defaultValue="0") int idade){ 
        Pessoa p = new Pessoa(); 
