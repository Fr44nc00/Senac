DROP DATABASE IF EXISTS `hospital_uc12`;
...
INSERT INTO `convenio` VALUES (1,'Amil','30 dias','12345678901234'),
(2,'SulAmérica','60 dias','56789012345678'),
(3,'Unimed','90 dias','90123456789012'),
(4,'Bradesco Saúde','120 dias','34567890123456')
,(5,'Medial Saúde','180 dias','78901234567890');
...
(1,'Maria da Silva','Rua A, 123','1990-01-01','(11) 1234-5678','123.456.789-00','1234567',1),
(2,'Carlos dos Santos','Rua B, 456','1985-05-15','(11) 8765-4321','987.654.321-00',
'7654321',2),
(3,'Eduardo Souza','Rua C, 789','2000-11-30','(11) 9876-5432','456.789.123-00','4567891',3),
(4,'João Silva','Rua D, 987','1995-08-10','(11) 4567-8901','159.753.456-00','1597534',4);
